...
// body: { missionId? }
//
// 신입 화면(MissionPage/FeedbackPage)은 Firestore SDK로 responses를 직접 읽지 않는다
// (README 참고: 문서를 통째로 읽으면 scores 필드까지 같이 내려온다).
// 대신 이 엔드포인트를 거쳐 feedback_text/nudge_text 등 안전한 필드만 받는다.
//
